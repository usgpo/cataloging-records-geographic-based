...
The selection of the records is based on a group of MARC metadata elements related to geographic coverage and governmental jurisdiction. The full names, abbreviations, and adjectival forms of the states and jurisdictions are used as the match points.
...
The zip file can also be downloaded directly at this link: [https://github.com/usgpo/cataloging-records-geographic-based/archive/refs/heads/main.zip](https://github.com/usgpo/cataloging-records-geographic-based/archive/refs/heads/main.zip)
...
MCS greatly appreciates feedback and questions about the repositories, collections, and resources. Please submit inquiries via [askGPO](https://ask.gpo.gov/s/), select the “Federal Depository Library” tile, and choose the “Cataloging/Metadata (Policy and Records)” category.
